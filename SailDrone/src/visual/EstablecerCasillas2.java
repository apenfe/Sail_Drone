...
public class EstablecerCasillas2 extends PApplet {
	...
	public EstablecerCasillas2(String mapa, Entorno entorno) {
		this.mapa=mapa;
	...
	public void draw() {
        ...
        text("Salida (Clic Derecho) x: "+rightX+", y: "+rightY, 5, 35);
		 ...
		 // Dibujar el texto
		  ...
		  this.entorno.setSalidaX(rightY); // y
			this.entorno.setSalidaY(rightX); // x
			this.entorno.setEntradaX(leftY); // y
			this.entorno.setEntradaY(leftX); // x
